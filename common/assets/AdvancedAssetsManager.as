package chimichanga.common.assets {
	...
	public class AdvancedAssetsManager implements IAssetsManager {
		...
		public function initialize( scaleFactor:Number = 1, onProgressCallback:Function = null, onCompleteCallback:Function = null, ... assetsToEnqueue ):void {
			
			assets.scaleFactor = scaleFactor;
			
			assets.enqueue.apply( null, assetsToEnqueue );
		...
		public function hasEnqueued():Boolean {
			
			return assets.numQueuedAssets > 0;
